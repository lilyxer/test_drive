...
lexicon_ru: dict[str, str] = {
    ...
    'До обеда': peresvet_feb,
    'После обеда': peresvet_feb,
...
cars: list[ModelD] = [
    ...
    ModelE(brand='Evolute', model='I-sky', engine='Синхронный двигатель с постоянными магнитами', power='204',
    ...
    ModelE(brand='Evolute', model='I-pro', engine='Синхронный двигатель с постоянными магнитами', power='150',
    ...
    ModelHE(brand='Voyah', model='Free_evr', engine='генератор 1.5T и 2 синхронных электродвигателя '
            ...
            equip='EVR', price='7 990 000', page='https://voyah.su/voyah-free-evr?main_menu/'),
    ModelHE(brand='Voyah', model='Free_evr_lr', engine='генератор 1.5T и 2 синхронных электродвигателя '
            ...
            susp='двурычажная адаптивная пневмоподвеска\nмногорычажная адаптивная пневмоподвеска',
            equip='EVR Long Range', price='8 490 000', page='https://voyah.su/voyah-free-evr-long-range?main_menu/'),
    ...
    ModelHE(brand='Voyah', model='Mhero_I', engine='генератор 1.5T и 3 электромотора', power='816',
            ...
            equip='EVR', price='ДОХУЯ', page='mhero.su/'),
]
