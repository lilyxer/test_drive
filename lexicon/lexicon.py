...
cars: list[ModelD] = [
    ...
    ModelHE(brand='Voyah', model='Free_evr', engine='генератор 1.5T и 2 электромотора', power='693',
    ...
    ModelHE(brand='Voyah', model='Free_evr_lr', engine='генератор 1.5T и 2 электромотора', power='489',
    ...
    ModelE(brand='Voyah', model='Free_ev', engine='2 электромотора', power='489', torque='750',
