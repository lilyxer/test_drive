...
lexicon_ru: dict[str, str] = {
    ...
    'Wey': str(Brand(name='Wey', concern='Dongfeng', foundation=2016,
                       type_of='гибридные и электрические автомобили', start=2023, site='https://gwm-wey.ru/')),
    'Oting': str(Brand(name='Oting', concern='Great Wall Motors', foundation=2024,
...
cars: list[ModelD] = [
    ...
    ModelD(brand='Chery', model='tiggo_7_pro_max', engine='1.5T - 1.6T', power='147 - 150', torque='210 - 275',
           ...
           price='2 720 000 - 3 270 000', page='https://www.chery.ru/models/tiggo7promax/'),
    ...
    ModelD(brand='Jaecoo', model='J8', engine='2.0T', power='249', torque='385',
           ...
           susp='независимая McPherson\nнезависимая многорычажная', drive='интеллектуальный полный', equip='Active Supreme SupremeV',
    ...
    ModelD(brand='Haval', model='H3', engine='1.5T', power='143 - 177', torque='210 - 270',
           acceleration='11.6 - 9.6', consumption='7.7 - 8.3', transmission='DCT7',
           size='4520 x 1875 x 1745', mass='1780', fuel='55', clearance='196',
           drive='передний - подключаемый полный', susp='независимая McPherson\nнезависимая многорычажная',
           equip='',
           price='', page='https://haval.ru/models/haval-h3/'),
    ...
    ModelD(brand='Geely', model='Monjaro', engine='2.0T', power='238', torque='350',
           ...
           price='4 244 990 - 4 744 990', page='https://www.geely-motors.com/model/monjaro/'),
