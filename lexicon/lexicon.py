...
lexicon_ru: dict[str, str] = {
    ...
    'Great Wall': str(Brand(name='Great Wall', concern='Great Wall Motors', foundation=1976,
                            ...
                            site='https://haval.ru/')),
    'GAC': str(Brand(name='GAC', concern='Guangzhou Automobile Group Co.', foundation=2008,
                     type_of='кроссоверы и внедорожники', start=2021,
                     site='https://gacmotor.com.ru/')),
    ...
    'Wey': str(Brand(name='Wey', concern='Great Wall Motors', foundation=2016,
                       type_of='гибридные и электрические автомобили', start=2023, site='https://gwm-wey.ru/')),
...
cars: list[ModelD, ModelE, ModelHE] = [
    ...
    ModelD(brand='GAC', model='M8', engine='2.0T', power='231', torque='380',
           acceleration='???', consumption='8.8', transmission='автоматическая AT8',
           size='5212 x 1893 x 1823', mass='???', fuel='65', clearance='???',
           drive='передний', susp='независимая McPherson\nнезависимая многорычажная',
           equip='GL GT GX GX_PREMIUM',
           price='5 499 999 - 6 499 999', page='https://gacmotor.com.ru/models/mpv/M8/'),
    ModelD(brand='GAC', model='GS8', engine='2.0T', power='231', torque='400',
           acceleration='9.2', consumption='???', transmission='автоматическая AT8',
           size='4980 x 1950 x 1780', mass='2105', fuel='65', clearance='160',
           drive='интеллектуальный полный', susp='независимая McPherson\nнезависимая многорычажная',
           equip='GL GT GX GX_PREMIUM',
           price='3 899 000 - 4 499 000', page='https://gacmotor.com.ru/models/suv/GS8II/'),
    ModelD(brand='GAC', model='GS5', engine='1.5T', power='137', torque='216',
           acceleration='???', consumption='7.5', transmission='механическая MT6 / автоматическая AT6',
           size='4695 x 1885 x 1726', mass='1592 - 1636', fuel='55', clearance='180',
           drive='интеллектуальный полный', susp='независимая McPherson\nнезависимая многорычажная',
           equip='Comfort Elite Luxe Premuim',
           price='2 249 000 - 2 709 000', page='https://gacmotor.com.ru/models/suv/GS5/'),
    ModelHE(brand='Wey', model='O5', engine='генератор 2.0T и 2 синхронных электродвигателя '
            'обратимая электромашина', power='421',
            torque='847', acceleration='5.2', wlpt='864', consumption='0.9', size='4870 x 1960 x 1690',
            mass='2340 - 2440', fuel='56', battery='40', clearance='160', drive='автоматически подключаемый полный',
            susp='независимая McPherson\nнезависимая многорычажная',
            equip='PREMIUM', price='6 499 000', page='https://gwm-wey.ru/models/wey-05/'),
]